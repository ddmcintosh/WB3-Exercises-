function getSocSecTax(grossPay) { //parameter is grossPay
let tax = grossPay * .062;
return tax;
}

function getMedicareTax(grossPay) { //parameter is grosspay
let tax = grossPay * .0145;
return tax;
}

function getFederalTax(grossPay, withholdingCode) { //parameters are grossPay & withholdingCode
